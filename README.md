...
- **PACE**: Prior Information Region Enhancement for complementary style, frequency, and noise-statistical enhancement;
- **CLRF**: Dynamic Important Region Token filtering for regional prediction;
...
model:
  clrf_hidden_dim: 256
  clrf_retain_ratio: 0.70
  use_pace: true
  pace_strength: 0.50
```

`clrf_retain_ratio` controls the proportion of important patch tokens retained by CLRF. PACE is applied only during training, preserving the behavior of the original implementation.
